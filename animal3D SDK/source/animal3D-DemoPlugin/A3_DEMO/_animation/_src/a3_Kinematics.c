...
//-----------------------------------------------------------------------------
	...
	a3real4x4Product(
		...
		hierarchyState->objectSpaceInv->hpose_base[index].transformMat.m		// Right-hand: this node object space.
	);
...
//-----------------------------------------------------------------------------
	...
	//a3kinematicsResolvePostIK(activeHS, baseHS, poseGroup, hierarchyObjIndex_affected, &m_affected.mm);
